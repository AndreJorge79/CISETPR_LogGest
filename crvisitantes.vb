...
Public Class crvisitantes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CISETPR_LogGest.crvisitantes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrvisitantes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crvisitantes = New crvisitantes()
        rpt.Site = Me.Site
        Return rpt
    End Function
