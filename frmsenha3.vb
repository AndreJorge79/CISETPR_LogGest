...
Public Class frmsenha3
    Dim connection As New OleDbConnection
    Dim Da As New OleDbDataAdapter
    Dim Dt As DataTable

    Private Sub frmsenha3_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub ApagarRegistosVisitantes()
        ...
        da.Fill(dt)
        Try
            MsgBox("Apagado com sucesso!", MsgBoxStyle.Information)
            Me.Close()
        Catch ex As Exception
