...
Public Class frmrelatoriovisitante
    ...
    Private Sub frmrelatoriovisitante_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        ApagarTudo()
        frmconsultas.Cursor = Cursors.Default
    End Sub
    

    Private Sub frmrelatoriovisitante_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
