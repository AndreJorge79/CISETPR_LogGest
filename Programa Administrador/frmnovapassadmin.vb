...
Public Class frmnovapassadmin
    ...
    Private Sub frmnovapass_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnok_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnok.Click
        If txtpass.Text = Nothing Then
            MsgBox("Por favor digite a nova senha!", MsgBoxStyle.Exclamation)
        Else
            AtualizarPass()
        End If
    End Sub
